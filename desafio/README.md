...
| **19A** | DevOps, CI/CD e Containers | Criação de Dockerfiles otimizados, pipelines de **CI/CD** no GitHub Actions e publicação de imagens em registry. |
| **19B** | Kubernetes | Definição de manifestos de **Kubernetes (k8s)** para deployment escalável, gerenciamento de segredos e escalabilidade automática (HPA). |
