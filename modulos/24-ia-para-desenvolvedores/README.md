...
- selecionar modelos por capacidade, risco, latência, privacidade e custo;
- projetar prompts, contexto, saídas estruturadas e validação;
- integrar modelos em TypeScript com adapters, testes, resiliência e estado controlado;
- usar IA para planejar, programar, revisar, depurar, testar e documentar com critério;
- criar fluxos com coding agents e ferramentas sem perder controle;
- projetar ingestão, recuperação, RAG e citações verificáveis;
...
| 24.05 | [Seleção de Modelos e Roteamento](24.05-selecao-de-modelos-e-roteamento.md) | Específica prática | Auditada |
| 24.06 | [Prompt e Context Engineering](24.06-prompt-e-context-engineering.md) | Específica prática | Auditada |
| 24.07 | [Saídas Estruturadas, Schemas e Validação](24.07-saidas-estruturadas-schemas-e-validacao.md) | Específica prática | Auditada |
| 24.08 | [Integração com APIs de IA em TypeScript](24.08-integracao-com-apis-de-ia-em-typescript.md) | Específica prática | Auditada |
| 24.09 | [Resiliência em APIs de IA](24.09-resiliencia-em-apis-de-ia.md) | Específica prática | Auditada |
| 24.10 | [Estado, Histórico e Memória Conversacional](24.10-estado-historico-e-memoria-conversacional.md) | Específica prática | Auditada |
| 24.11 | [IA para Planejar e Escrever Código](24.11-ia-para-planejar-e-escrever-codigo.md) | Específica prática | Auditada |
| 24.12 | [Revisão, Segurança e Quality Gates](24.12-revisao-seguranca-e-quality-gates.md) | Específica prática | Auditada |
| 24.13 | [Debug, Testes e Documentação com IA](24.13-debug-testes-e-documentacao-com-ia.md) | Específica prática | Auditada |
| 24.14 | [Coding Agents](24.14-coding-agents.md) | Específica ampla | Auditada |
| 24.15 | [Workflows com Agentes](24.15-workflows-com-agentes.md) | Específica prática | Auditada |
| 24.16 | [Function Calling e Tool Calling](24.16-function-calling-e-tool-calling.md) | Específica prática | Auditada |
| 24.17 | [Agentes com Ferramentas](24.17-agentes-com-ferramentas.md) | Específica prática | Auditada |
| 24.18 | [OWASP Top 10 para LLM Applications](24.18-owasp-top-10-para-llm-applications.md) | Específica ampla | Auditada |
| 24.19 | [OWASP Agentic AI Top 10](24.19-owasp-agentic-ai-top-10.md) | Específica ampla | Auditada |
| 24.20 | [Embeddings e Recuperação Semântica](24.20-embeddings-e-recuperacao-semantica.md) | Específica prática | Auditada |
| 24.21 | [Ingestão, Chunking e Ciclo de Vida dos Documentos](24.21-ingestao-chunking-e-ciclo-de-vida-dos-documentos.md) | Específica prática | Auditada |
| 24.22 | [RAG: Busca, Citações e Fidelidade](24.22-rag-busca-citacoes-e-fidelidade.md) | Específica prática | Auditada |
| 24.23 | [Avaliação de Respostas de IA](24.23-avaliacao-de-respostas-de-ia.md) | Específica prática | Auditada |
| 24.24 | [Evals e Datasets de Avaliação](24.24-evals-e-datasets-de-avaliacao.md) | Específica prática | Auditada |
| 24.25 | [Guardrails, UX e Escalonamento Humano](24.25-guardrails-ux-e-escalonamento-humano.md) | Específica prática | Auditada |
| 24.26 | [Custos e Observabilidade em Apps com IA](24.26-custos-e-observabilidade-em-apps-com-ia.md) | Específica prática | Auditada |
| 24.27 | [LLMOps, FinOps, Versionamento e Rollback](24.27-llmops-finops-versionamento-e-rollback.md) | Específica prática | Auditada |
...
Este módulo está organizado em seis blocos. Cada exercício encerra um bloco e deve ser concluído antes de avançar para os componentes que dependem dele.

**Bloco A — Fundamentos e Governança** · aulas 24.01–24.05
IA generativa, tokens, contexto, limitações, privacidade e seleção de modelos.
Pré-requisito: nenhum (ponto de entrada do módulo).

**Bloco B — Integração Fullstack** · aulas 24.06–24.10
Context engineering, saídas estruturadas, adapters TypeScript, resiliência e estado conversacional.
Pré-requisito: Bloco A.

**Bloco C — IA no Desenvolvimento** · aulas 24.11–24.15
Planejamento, código, revisão, gates, debug, testes, documentação, coding agents e workflows.
Pré-requisito: Bloco B.

**Bloco D — Ferramentas e Segurança** · aulas 24.16–24.19
Tool calling, agentes com ferramentas e threat modeling para aplicações com LLM e agentes.
Pré-requisito: Blocos B e C.

**Bloco E — Recuperação e Avaliação** · aulas 24.20–24.25
Embeddings, ingestão, RAG, citações, avaliação, evals, guardrails e experiência humana.
Pré-requisito: Blocos A–D.

**Bloco F — Produção** · aulas 24.26–24.28
Observabilidade, custos, LLMOps, FinOps, rollout, rollback e projeto final.
...
- [Exercício 02 — Integração e Resiliência](exercicios/02-workflow-desenvolvimento.md)
...
1. Especifica problema, limites, dados, riscos, modelo e alternativa sem IA.
2. Define contrato estruturado, adapter TypeScript, estado, timeout, fallback e testes.
...
Contexto do módulo:
- Descrição do módulo: O módulo ensina fundamentos e governança, seleção de modelos, contexto, schemas, integração TypeScript, resiliência, memória, uso de IA no desenvolvimento, agentes, RAG, avaliação, segurança e operação.
